...
return [
    ...
    */
    'custom_types'               => [
        'guid' => Ramsey\Uuid\Doctrine\UuidType::class,
        'role' => \App\Domain\User\Entity\Types\RoleType::class,
        'gender' => \App\Domain\User\Entity\Types\GenderType::class
    ],
    /*
    |--------------------------------------------------------------------------
